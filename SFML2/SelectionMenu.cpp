...
void SelectionMenu::updateButtons()
{
	...
	//{
	//	//this->states->push(new Difficulty menu(this->window, this->supportedKeys, this->states));
	...
	//{
	//	//this->states->push(new Scenery menu (this->window, this->supportedKeys, this->states));
