...
{
	this->buttons["CHARACTER1"] = new Button(880, 160, 250, 80, &this->font, "Character 1",
		sf::Color::Green, sf::Color(255, 0, 0, 150), sf::Color(20, 20, 20, 200));

	this->buttons["CHARACTER2"] = new Button(880, 250, 250, 80, &this->font, "Character 2",
		sf::Color::Yellow, sf::Color(255, 0, 0, 150), sf::Color(20, 20, 20, 200));

	this->buttons["CHARACTER3"] = new Button(880, 350, 250, 80, &this->font, "Character 3",
		sf::Color::Magenta, sf::Color(255, 0, 0, 150), sf::Color(20, 20, 20, 200));

	this->buttons["CHARACTER4"] = new Button(880, 450, 250, 80, &this->font, "Character 4",
...
void CharacterSelecMenuState::updateButtons()
{
	...
	// new game 
	if (this->buttons["CHARACTER2"]->isPressed())
	{
		this->states->pop();
